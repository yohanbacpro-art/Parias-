...
aly_nuit_elle:{
  ...
  texte:[
    ...
    "§ La porte se referme sur une chambre haute d'auberge de bourg, avec une pluie de trois jours contre le volet.",
    { sobre:"Il n'y a rien d'écrit, rien de fixé, rien de dû.",
      intense:"Il n'y a rien d'écrit, rien de fixé, rien de dû, et c'est une expérience entièrement nouvelle pour vous deux — pour elle parce qu'elle n'a jamais rien laissé se passer qu'elle n'ait pas calculé, pour vous parce que depuis onze ans quelqu'un signait toujours avant.",
      extreme:"Il n'y a rien d'écrit, rien de fixé, rien de dû. C'est entièrement nouveau pour vous deux, et pas de la même façon : pour elle parce qu'elle n'a jamais rien laissé se produire qu'elle n'ait pas calculé trois jours plus tôt ; pour vous parce que depuis onze ans il y avait toujours un père, un oncle, un intendant, une signature au bas d'une page, et une femme qui savait exactement ce qu'elle faisait là. Ici il n'y a personne d'autre dans l'histoire. Il n'y a personne du tout, et c'est vertigineux d'une façon qu'aucun des deux n'avait prévue." },
    "Elle est brusque, et attentive, et elle rit une fois — le même son court, sans grâce.",
    "Elle a des cicatrices sur le flanc gauche, quatre, parallèles, anciennes, et quand votre main s'arrête dessus elle dit « Callensbourg » sans ouvrir les yeux, et rien d'autre, et ça suffit.",
    "§ À un moment de la nuit, très tard, elle demande : « Vous dormez de quel côté ? » — et c'est la question la plus intime de toute la soirée, parce que c'est celle qui suppose une deuxième nuit.",
  ],
  effets:{ flags:['aly_nuit','aly_amants'],
           faire:() => bouger('alycia', { relation:6, confiance:5, attirance:8 }),
           marque:"Une chambre haute, trois jours de pluie, rien de signé. Elle a demandé de quel côté vous dormiez.",
           court:"De quel côté" },
  choix:[
...
aly_nuit_dire:{
  ...
  suite:'aly_nuit_apres', libelleSuite:"Après" },
