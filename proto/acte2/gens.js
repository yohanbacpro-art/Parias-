...
acte_charles:{
  ...
  texte:[
    ...
    { sobre:"« Parce que six de mes hommes ne sont pas rentrés d'une crypte. »",
      ...
      extreme:"« Parce que six de mes hommes ne sont pas rentrés d'une crypte, et que quatre d'entre eux sont morts sans une blessure — pas une entaille, pas un os, rien. » Il s'assied sans qu'on l'invite, pose ses deux mains à plat sur la table, et ce sont des mains de charpentier avec un ongle noir. « Je forme des hommes depuis vingt-deux ans à tuer ce qui n'est pas humain. J'en ai enterré cent quatorze. Je connais le nom des cent quatorze et la façon dont chacun est mort, et il y en a quatre pour lesquels je n'ai pas de ligne à écrire. Ça m'empêche de dormir depuis Germinal. »" },
