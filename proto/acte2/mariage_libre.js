...
aly_epouser:{
  ...
  texte:[
    ...
    { sobre:"« Il y a un empêchement d'écriture. »",
      intense:"« Il y a un empêchement d'écriture », dit-elle, un soir, sans préambule, après trois semaines pendant lesquelles elle n'a manifestement pensé qu'à ça.",
      extreme:"« Il y a un empêchement d'écriture », dit-elle un soir, sans préambule d'aucune sorte, après trois semaines pendant lesquelles elle a été distraite, brusque et deux fois désagréable sans raison — trois semaines pendant lesquelles il est maintenant évident qu'elle n'a pensé qu'à ça et qu'elle a cherché une façon d'en parler qui ne ressemble pas à une demande." },
    "« Lequel ? »",
...
aly_ep_callensbourg:{
  ...
  texte:[
    ...
    "« Non. »",
    "« Le relèvement d'un titre éteint se fait. Il y a une voie pour ça. Je l'ai prise. »",
    ...
    { sobre:"@« Alors n'entrez pas. »",
      ...
      extreme:"« Alors n'entrez pas », dites-vous. « J'y vais seul, avec ce que j'ai : un relèvement déjà obtenu, un titre au registre, et le droit d'attester en justice pour une maison éteinte de la même province. Ce n'est pas la bonne voie. C'en est une voisine, et un commissaire aux titres fatigué un vendredi peut confondre les deux. »" },
    "« Ça ne marchera pas. »",
    "Ça marche.",
