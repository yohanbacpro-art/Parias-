...
in_so_signe:{
  ...
  effets:{ flags:['in_fait_sorgue','a3_chastel_venu','a3_tombee'],
           cout:{ moral:14 },
...
in_so_non:{
  ...
  effets:{ flags:['in_fait_sorgue','in_so_refuse'],
...
in_so_attente:{
  ...
  effets:{ flags:['in_fait_sorgue','in_so_fini','in_so_epargne'],
           cout:{ endurance:24 },
...
in_so_entree:{
  ...
  effets:{ flags:['in_fait_sorgue','in_so_fini','in_so_battu'],
           cout:{ endurance:18 },
...
in_so_rien:{
  ...
  effets:{ flags:['in_fait_sorgue','in_so_fini','in_so_marche'],
...
in_so_ko:{
  ...
  effets:{ flags:['in_fait_sorgue','in_so_fini','in_so_perdu'],
...
in_ch_inscrit:{
  ...
  effets:{ flags:['in_fait_charles','in_ch_inscrit','a2_registre_onde'],
...
in_ch_non:{
  ...
  effets:{ flags:['in_fait_charles','in_ch_refuse'],
           cout:{ moral:6 },
...
in_ch_registre:{
  ...
  effets:{ flags:['in_fait_charles','in_ch_registre','a2_registre_onde'],
...
in_ch_registre_cout:{
  ...
  effets:{ flags:['in_fait_charles','in_ch_demande'],
...
in_ch_registre_ko:{
  ...
  effets:{ flags:['in_fait_charles','in_ch_note','a2_charles_froid'],
           cout:{ moral:8 },
...
in_sa_rond:{
  ...
  effets:{ flags:['in_fait_sault','in_sa_blanche'],
...
in_sa_ecrire:{
  ...
  effets:{ flags:['in_fait_sault','in_sa_ecrit'],
...
in_sa_rester:{
  ...
  effets:{ flags:['in_fait_sault','in_sa_reste','a3_chroniqueur'],
...
in_ysabel:{
  ...
  effets:{ flags:['in_fait_ysabel','in_ys_confirme','a2_titre_inattaquable'],
