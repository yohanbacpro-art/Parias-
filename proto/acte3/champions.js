 ...
 *
 *   RENAUD SORGUE  finit une phrase commencée il y a douze ans dans un
 *                  rond de neuf pas. Il avait cinquante-deux ans ; il en a
 *                  soixante-quatre. Vous en aviez vingt-neuf.
 *
...
/* ══════════════════════════════════════════════════════════════════════════
 * RENAUD SORGUE · soixante-quatre ans
 *
 * Il l'a dit lui-même, il y a douze ans, à la fin du deuxième temps :
...
in_sorgue:{
  ...
  titre:"Un homme de soixante-quatre ans",
  texte:[
    ...
    { sobre:"Il a soixante-quatre ans. Ça se voit et il ne le cache pas.",
      intense:"Il a soixante-quatre ans. Ça se voit à la façon dont il descend de cheval — en deux temps, en s'appuyant, sans se presser — et il ne fait rien du tout pour le cacher, ce qui est déjà un renseignement.",
      extreme:"Il a soixante-quatre ans et ça se voit à une seule chose : il descend de cheval en deux temps, la main gauche à plat sur le troussequin, en posant d'abord le pied droit.\n\nIl ne fait rigoureusement rien pour le dissimuler. Un homme de son métier qui laisse voir ça devant témoins a fait un calcul et l'a fait il y a longtemps : il n'y a plus rien à cacher, il ne travaille plus à l'illusion, et il économise ce qui lui reste pour l'endroit où ça comptera.\n\nC'est infiniment plus inquiétant que si vous ne l'aviez pas vu." },
    ...
    "§ Douze ans. Il en a soixante-quatre. Vous en avez quarante et un.",
    { sobre:"^« L'écart s'est refermé. »",
      intense:"^« L'écart s'est refermé du mauvais côté pour moi », dit-il, et il le dit comme on lit un relevé. « Vingt-trois ans d'écart, alors. Vingt-trois aujourd'hui. Sauf que vingt-neuf contre cinquante-deux et quarante et un contre soixante-quatre, ce n'est pas la même arithmétique. »",
      extreme:"^« L'écart n'a pas bougé et il s'est refermé quand même », dit-il, exactement du ton dont il lisait les règles du rond. « C'est ce que je n'avais pas prévu à cinquante-deux ans.\n\nVingt-trois ans nous séparaient alors, vingt-trois nous séparent aujourd'hui. Mais vingt-neuf contre cinquante-deux, c'est un homme qui a l'expérience contre un homme qui a le souffle. Quarante et un contre soixante-quatre, c'est un homme qui a les deux contre un homme qui n'a plus que l'expérience.\n\nJe le sais. C'est même ma spécialité, savoir ce genre de chose. Quarante et un duels, et je n'en ai jamais perdu un parce que je m'étais trompé sur l'arithmétique. »\n\nIl finit avec le gant gauche.\n\n« Je suis venu quand même. Ça devrait vous renseigner sur ce que ce soir-là m'a coûté. »" },
  ],
  effets:{ flags:['in_sorgue_vu'],
           marque:"Renaud Sorgue est venu seul à Karlsberg. Soixante-quatre ans, et une phrase à finir.",
           court:"Soixante-quatre ans" },
  choix:[
    { t:"Tracer le rond",
    ...
    { t:"« Non. »",
      detail:"un homme de soixante-quatre ans qui a fait quatre jours de route · et vous dites non",
...
in_so_role_dom:{
  ...
  choix:[
    ...
    { t:"« Faites le signe. »",
      ...
      risque:"définitif",
      ferme:"Ferme : ce que douze ans de silence entre vous valaient",
      va:'in_so_signe' },
  ],
},
...
in_so_role_ko:{
  ...
  choix:[
    { t:"Tracer le rond",
      ...
      risque:"définitif", va:'in_so_rond' },
    { t:"« Non. »",
      detail:"un homme de soixante-quatre ans, quatre jours de route, et un refus",
      risque:"calculé", va:'in_so_non' },
  ],
},
...
in_so_non:{
  ...
  effets:{ flags:['in_sorgue_fait','in_fait_sorgue','in_so_refuse'],
           ...
           exploit:{ eclat:2, temoins:'quelques', quoi:"vous avez refusé le rond à un homme de soixante-quatre ans" },
...
in_so_rond:{
  ...
  titre:"Neuf pas, douze ans plus tard",
  texte:[
    "Il trace le rond lui-même, à la craie, sur les pavés de votre cour. Neuf pas, mesurés au pied, en marchant — et il met sensiblement plus longtemps qu'il y a douze ans.",
    { sobre:"La maison entière est sortie. Personne ne dit rien.",
      intense:"La maison entière est sortie et s'est rangée contre les murs sans qu'on le lui demande. Trois cents personnes, et pas un bruit : elles savent toutes qui est cet homme parce qu'on leur a raconté l'assise d'hiver pendant douze ans.",
      extreme:"La maison entière est sortie et s'est rangée d'elle-même contre les murs de la cour, à la distance exacte où l'on se met quand on a déjà vu ça ou qu'on l'a assez entendu raconter.\n\nTrois cents personnes. Pas un bruit, pas un pari, pas un commentaire.\n\nElles savent toutes qui est cet homme. On leur a raconté l'assise d'hiver pendant douze ans, tous les hivers, et l'histoire s'est considérablement améliorée en route — mais le nom, lui, n'a pas bougé d'un pouce." },
    "« Trois temps chacun », dit-il. « Comme la dernière fois. »",
    "@« Vous n'en aviez pris qu'un. »",
    "« J'en prendrai trois. » Il n'y a pas d'humour là-dedans. « C'est l'autre chose qui change à soixante-quatre ans : on prend tous ses temps, et on les prend tôt. »",
    { sobre:"§ Il salue. Le salut est exactement le même.",
      intense:"§ Il salue, et le salut est exactement le même qu'il y a douze ans : pointe basse, pied arrière, la tête qui ne dépasse pas ce qu'elle doit dépasser. Pas un pouce de perdu.\n\nC'est la dernière chose de cet homme qui n'ait pas vieilli.",
      extreme:"§ Il salue, et le salut est rigoureusement identique à celui d'il y a douze ans. Pointe basse. Pied arrière. Une inclinaison de tête qui ne dépasse pas d'un pouce ce qu'elle doit dépasser.\n\nPas un cheveu de perdu, pas une hésitation, pas un tremblement.\n\nC'est la dernière chose chez cet homme qui n'ait pas vieilli, et il le sait, et c'est probablement la raison pour laquelle il l'a fait si lentement." },
  ],
...
in_so_attente:{
  ...
  texte:[
    ...
    { sobre:"À la quatre-vingtième seconde, la garde descend de trois pouces.",
      ...
      extreme:"À la quatre-vingtième seconde, la garde descend de trois pouces.\n\nCe n'est pas de la fatigue visible. Il ne souffle pas, il ne ralentit pas, son visage ne dit rien du tout. Le bras descend la garde tout seul, sans demander la permission à personne, et il n'existe aucune volonté au monde qui fasse remonter un bras de soixante-quatre ans quand il a décidé.\n\nIl le sent à la seconde exacte où ça se produit — il a passé quarante ans à guetter ça chez les autres.\n\nIl lève deux doigts. Premier temps." },
    ...
    { sobre:"Au troisième, il baisse la lame lui-même.",
      ...
      extreme:"Au troisième temps, il ne remonte pas la garde.\n\nIl baisse la lame à hauteur de cuisse, il reste debout au milieu du rond, et il ne dit rien pendant un temps que personne dans cette cour n'ose interrompre.\n\n« Voilà », dit-il enfin. « C'était ça, la phrase. »\n\n@« Vous saviez. »\n\n« Depuis le premier soir. » Il regarde la craie. « Un homme de cinquante-deux ans et un homme de vingt-neuf : je vous ai dit ça il y a douze ans en croyant que c'était une menace. C'en était une, à l'époque.\n\nJ'ai eu douze ans pour comprendre que c'était une date. »" },
  ],
...
in_so_rien:{
  ...
  texte:[
    ...
    { sobre:"^« Vous me faites marcher. »",
      intense:"^« Vous me faites marcher. » Il baisse la lame. « Il y a douze ans, dans une salle de Cendrepont, j'ai dit à un homme de vingt-neuf ans qu'il ne m'avait pas encore fait marcher et que c'était la seule chose qui lui restait. »\n\n@« Vous vous en souvenez. »\n\n« Je me souviens de tout. C'est la partie du métier dont personne ne parle. »",
      extreme:"^« Vous me faites marcher. »\n\nIl baisse la lame complètement.\n\n« Il y a douze ans, dans une salle de Cendrepont, entre le deuxième et le troisième temps, j'ai dit à un homme de vingt-neuf ans qu'il ne m'avait pas encore fait marcher et que c'était très exactement la seule chose qui lui restait à essayer. »\n\n@« Vous vous en souvenez. »\n\n« Je me souviens de tout, messire. De tout, dans l'ordre, avec le temps qu'il faisait. C'est la partie de ce métier dont personne ne parle jamais et c'est celle qui coûte le plus cher. »\n\nIl regarde le rond qu'il vient de tracer sur vos pavés.\n\n« Quarante et un duels. Je peux vous les réciter. Il n'y en a pas un seul dont j'aie envie. »" },
...
in_so_cout:{
  ...
  texte:[
    "Il a soixante-quatre ans et il a encore la main, et vous l'apprenez de la façon dont on apprend ce genre de chose.",
  ...
  effets:{ flags:['in_sorgue_fait','in_fait_sorgue','in_so_fini','in_so_battu'],
           ...
           marque:"Il vous a ouvert le flanc à soixante-quatre ans. Vous l'avez fini onze secondes plus tard.",
           court:"Onze secondes" },
  suite:'in_so_apres', libelleSuite:"Ce qu'on en fait" },
...
/* ══════════════════════════════════════════════════════════════════════════
 * CHARLES DE MONT-DRAKEN · soixante-dix ans
 *
...
in_charles:{
  ...
  texte:[
    "Il arrive avec vingt hommes et il les laisse dans la cour. Il monte seul, il retire son manteau, et il s'assied sans qu'on l'y invite — comme la première fois, il y a douze ans, dans une salle de relais.",
    { sobre:"Il a soixante-dix ans. Il tient toujours son compte.",
      intense:"Il a soixante-dix ans. Les mains sont les mêmes — des mains de charpentier avec un ongle noir — et il pose sur la table un registre relié qu'il n'avait pas la dernière fois.",
      extreme:"Il a soixante-dix ans et il n'a rien perdu de ce qui comptait chez lui : les mains sont les mêmes, des mains de charpentier avec un ongle noir, et elles se posent à plat sur le bois avant qu'il ne parle, exactement comme il y a douze ans.\n\nCe qui est nouveau, c'est le registre. Un volume relié, épais de deux pouces, qu'il pose devant lui sans l'ouvrir et sur lequel il garde la main gauche pendant tout l'entretien." },
    ...
    { sobre:"« Quatre-vingt-quatorze inscrits. »",
      intense:"« Quatre-vingt-quatorze inscrits. » Il n'a pas besoin de l'ouvrir. « En onze ans. Sur quatre provinces. Je le tiens de ma main tous les mois et personne ne l'a jamais vu que moi et deux magistrats. »",
      extreme:"« Quatre-vingt-quatorze inscrits. »\n\nIl n'ouvre pas le volume et il n'en a pas besoin.\n\n« En onze ans, sur quatre provinces. Chaque ligne porte un nom, une date, un lieu, ce que la personne a fait et devant combien de témoins. Je l'écris de ma main tous les mois. Personne ne l'a jamais lu, sauf moi et deux magistrats qui n'avaient pas le choix. »\n\nUn temps.\n\n« Sur les quatre-vingt-quatorze, soixante et onze sont vivants. Onze ont une charge. Quatre enseignent. Trois sont morts de vieillesse.\n\nAucun n'a été brûlé. C'est le chiffre pour lequel j'ai passé trente ans à me faire traiter de boucher par les deux camps. »" },
...
in_ch_registre:{
  ...
  texte:[
    ...
    "@« Vous avez soixante-dix ans, c'est votre dernier hiver, et le prochain n'aura pas votre registre. Vous l'avez dit vous-même. »",
...
/* ══════════════════════════════════════════════════════════════════════════
 * GUILLAUME DE SAULT · quarante-huit ans
 *
 ...
 * mis douze ans à revenir parce qu'il tient une liste et pas une rancune.
 *
...
in_sault:{
  ...
  texte:[
    ...
    { sobre:"Il a quarante-huit ans et le même pourpoint gris.",
      intense:"Quarante-huit ans, le même pourpoint gris de bonne coupe entretenu par quelqu'un, et le carnet dans la même poche intérieure.\n\nLes mains ont des marques, maintenant. Deux.",
      extreme:"Quarante-huit ans. Le même pourpoint gris de bonne coupe, entretenu par quelqu'un dont c'est le travail, et le carnet dans la même poche intérieure.\n\nLes mains ont des marques, maintenant. Deux : une sur le dos de la gauche, une qui traverse le pouce droit.\n\nEn douze ans, il a eu à parer deux fois. C'est un renseignement complet sur ce qu'ont été ces douze ans." },
    "« J'ai écrit *à revoir dans deux ans* », dit-il sans se retourner. « Il y a douze. »",
    "@« Vous êtes en retard. »",
    { sobre:"« Je suis en retard de dix ans et j'ai une bonne raison. »",
      intense:"« De dix ans, oui. J'ai une raison et elle est mauvaise. » Il sort le carnet. « Je ne savais pas quoi écrire. »",
      extreme:"« De dix ans, oui. J'ai une raison et elle est très mauvaise. »\n\nIl sort le carnet de sa poche intérieure — le même, relié, plus épais qu'avant — et il le tient sans l'ouvrir.\n\n« Je ne savais pas quoi écrire.\n\nÇa ne m'était jamais arrivé en onze ans. Ça m'est arrivé pour vous et ça ne s'est pas arrangé, et j'ai mis dix ans à comprendre pourquoi. »" },
    "§ Il ouvre le carnet. Il est beaucoup plus épais qu'il y a douze ans.",
    { sobre:"^« Cent quarante et un noms. »",
      intense:"^« Cent quarante et un noms, maintenant. » Il tourne les pages sans chercher. « Trois lignes chacun. Où, contre quoi, comment ça a fini.\n\nEt une page blanche. »",
      extreme:"^« Cent quarante et un noms, maintenant. »\n\nIl tourne les pages sans chercher : il sait exactement où sont les choses dans son propre carnet.\n\n« Trois lignes chacun. Où, contre quoi, comment ça a fini. Vingt-trois croix pour ceux que je n'ai pas rencontrés, dont onze qui ont refusé.\n\nEt une page blanche. »\n\nIl l'ouvre.\n\n« La vôtre. J'ai fait le trajet quatre fois en douze ans. Quatre fois. La première, vous étiez à Sainte-Ombre. La deuxième, vous meniez une bataille pour des Nains. La troisième, on m'a dit que vous aviez levé une vallée sans contrat pour rouvrir une chaussée que Chastel laissait fermée.\n\nÀ chaque fois je repartais parce que je ne savais pas quoi mettre dans les trois lignes. »" },
    "@« Et cette fois ? »",
    { sobre:"« Cette fois j'ai regardé la vallée. »",
      ...
      extreme:"« Cette fois j'ai passé une heure entière ici avant que quelqu'un vienne me chercher, et j'ai regardé la vallée. »\n\nIl referme le carnet sur son doigt.\n\n« Trois cents feux. Un intendant de vingt-quatre ans qui tient des comptes que j'ai demandé à voir et qu'on m'a montrés sans hésiter, ce qui ne se fait nulle part. Une maison relevée qui a tenu un siège.\n\nJe tiens un carnet de trois lignes, messire. Trois lignes, c'est fait pour un homme dans un rond : où, contre quoi, comment ça a fini. C'est parfait pour ça et ça ne sert à rien d'autre.\n\nJ'ai passé onze ans à croire que je gardais la mémoire des hommes qui valaient quelque chose. J'ai passé les douze suivants à comprendre que je gardais la mémoire de la seule chose que je savais mesurer. »" },
  ],
  effets:{ flags:['in_sault_vu'],
           marque:"Cent quarante et un noms, vingt-trois croix, et une page blanche depuis douze ans.",
  ...
  choix:[
    ...
    { t:"Lui proposer autre chose que trois lignes",
      detail:"un homme qui tient un registre depuis vingt-trois ans, et une maison qui en cherche un",
      si:() => a('a3_tenu'),
...
in_sa_rond:{
  ...
  texte:[
    "@« Tracez le rond. »",
    { sobre:"Il ne bouge pas.",
      intense:"Il ne bouge pas. Puis il rit — une fois, court, sans amertume, le même rire qu'il y a douze ans quand vous lui aviez servi son propre enchaînement.\n\n« Non », dit-il.",
      extreme:"Il ne bouge pas d'un pouce. Il regarde la craie qu'il n'a pas sortie, le chemin de ronde, la vallée.\n\nPuis il rit. Une fois, court, sans une once d'amertume — très exactement le même rire qu'il y a douze ans, dans une cour de relais, quand vous lui aviez servi son propre enchaînement.\n\n« Non », dit-il." },
    { sobre:"^« Je ne suis pas venu pour ça. »",
      intense:"^« Je ne suis pas venu pour ça, et vous le savez, et vous me le proposez pour m'éviter d'avoir à le dire. »\n\nIl remet le carnet dans sa poche.\n\n« C'est courtois. C'est la chose la plus courtoise qu'on m'ait faite en vingt-trois ans, et je préfère quand même le dire. »",
      extreme:"^« Je ne suis pas venu pour ça. Vous le savez parfaitement, et vous venez de me le proposer pour m'éviter d'avoir à le dire à voix haute.\n\nC'est courtois. C'est très probablement la chose la plus courtoise qu'on m'ait faite en vingt-trois ans de carnet, et je préfère quand même le dire. »\n\nIl remet le carnet dans sa poche intérieure.\n\n« Un rond de neuf pas entre un homme de quarante-huit ans et un homme de quarante et un qui a tenu un siège il y a trois semaines ne renseigne sur rien du tout. Ça ferait trois lignes fausses.\n\nJ'ai cent quarante et une pages. Je peux vivre avec une blanche. Je ne peux pas vivre avec une fausse. »" },
...
in_sa_ecrire:{
  ...
  texte:[
    ...
    { sobre:"^« *Karlsberg. N'est pas entré dans le rond. Trois cents feux.* »",
      intense:"^« *Karlsberg, la trente-troisième année. Épée bâtarde, bonne main, a appris où regarder. N'est pas entré dans le rond et n'avait pas à y entrer.*\n\n*Trois cents feux au pied du mur. C'est la seule ligne de ce carnet qui compte autre chose que des hommes seuls, et je ne sais pas quoi en faire.* »",
      extreme:"^« *Karlsberg, la trente-troisième année après la Purge.*\n\n*Épée bâtarde, bonne main, a appris où regarder — ce que trente et un sur cent quarante et un n'apprennent jamais.*\n\n*N'est pas entré dans le rond, et n'avait aucune raison d'y entrer. Trois cents feux au pied du mur, un intendant qui tient les comptes, une chaussée rouverte sans contrat.*\n\n*C'est la seule ligne de ce carnet qui compte autre chose que des hommes seuls. Je ne sais pas quoi en faire et je l'écris quand même, parce qu'un registre qui n'écrit que ce qu'il sait mesurer ment par omission pendant vingt-trois ans.* »\n\nIl referme le carnet.\n\n« C'est quatre lignes. Je n'en avais jamais écrit quatre. »" },
...
in_sa_rester:{
  qui:'sault',
  titre:"Vingt-trois ans de registre",
  texte:[
    "@« Vous tenez un registre depuis vingt-trois ans. »",
    "« Un carnet. »",
    "@« Vous avez dit *registre*, il y a douze ans, dans une cour de relais. Vous avez dit qu'une maison a un registre, une province un cartulaire, et un homme d'armes rien du tout. »",
    { sobre:"Il ne dit rien.",
      intense:"Il ne dit rien pendant un long moment. Il n'avait manifestement pas prévu qu'on lui rende ses propres mots à douze ans de distance.\n\n« Vous avez retenu ça. »\n\n@« Vous étiez le premier à me l'expliquer. »",
      extreme:"Il ne dit rien pendant un très long moment.\n\nIl n'avait manifestement pas prévu qu'on lui rende ses propres mots à douze ans de distance, et il est en train de vérifier, dans sa tête, s'il les a bien dits — ce qui prend quelques secondes chez un homme qui se souvient de tout.\n\n« Vous avez retenu ça. »\n\n@« Vous étiez le premier à me l'expliquer, et vous me l'avez expliqué en pensant que ça ne servirait à personne. »" },
  ...
  plusTard:"Cent quarante et un noms sont entrés aux archives de Karlsberg avec lui. Ils n'iront pas dans un grenier.",
  suite:'a3_champions', libelleSuite:"Après" },

/* ══════════════════════════════════════════════════════════════════════════
 * YSABEL DE KARLSBERG · quatre-vingt-un ans
 *
...
in_ysabel:{
  ...
  texte:[
    "Elle n'est pas venue. Elle a quatre-vingt-un ans et elle n'a pas quitté Sainte-Ombre depuis trente et un ans.",
    ...
    { sobre:"Quatre lignes. Écrites de sa main, scellées de son cachet.",
      intense:"Quatre lignes, écrites d'une main de quatre-vingt-un ans qui n'a pas tremblé, scellées d'un cachet que vous connaissez parce que vous en avez tenu le pareil dans une crypte il y a quinze ans.\n\nLe clerc vous les lit à voix haute. La forme l'exige.",
      extreme:"Quatre lignes.\n\nÉcrites d'une main de quatre-vingt-un ans qui n'a pas tremblé une seule fois sur quatre lignes, scellées d'un cachet que vous reconnaissez immédiatement : vous en avez tenu le pareil dans une crypte, il y a quinze ans, sur un coffre dont votre tante avait la clef.\n\nLe clerc vous les lit à voix haute parce que la forme l'exige et parce qu'un acte doit être entendu par celui qu'il vise.\n\nIl lit mal. Il lit comme un homme qui a compris ce qu'il porte." },
    ...
    { sobre:"^« Je sais faire les deux. On ne m'a jamais demandé de faire l'autre. »",
      ...
      extreme:"Vous la lisez vous-même, à voix basse, et deux fois.\n\n^« Je sais faire les deux, messire. On ne m'a simplement jamais demandé de faire l'autre.\n\nVous avez refermé la porte du parloir et vous êtes parti sans me dire ce que vous vouliez. J'ai mis douze ans à décider que ce n'était pas parce que vous n'aviez rien à me demander. »" },
  ],
  ...
  choix:[
    { t:"Lui répondre",
      detail:"quatre lieues d'une route de poste · elle en a quatre-vingt-un · et vous savez écrire",
      risque:"calculé", va:'in_ys_repondre' },

    { t:"Ne pas répondre",
      detail:"elle n'a rien demandé · c'est même toute la question depuis douze ans",
...
in_ys_repondre:{
  ...
  texte:[
    "Vous écrivez. Ça prend trois soirs et deux brouillons brûlés, ce qui est peu pour une lettre qu'on doit à quelqu'un depuis douze ans.",
    { sobre:"Vous n'écrivez pas de pardon. Il n'y en a pas à donner.",
      ...
      extreme:"Vous n'écrivez pas de pardon.\n\nIl n'y en a pas à donner et elle serait la première à refuser d'en recevoir un. Sept cents personnes se sont couchées nobles et se sont réveillées inexistantes ; un garçon de neuf ans est sorti par la porte au lieu de descendre par la cave ; et rien de ce qu'un homme peut écrire ne touche à ça, jamais, sous aucune forme.\n\nVous écrivez la seule chose qu'elle vous ait demandée en douze ans sans jamais la demander : ce que vous vouliez, ce matin-là, en refermant la porte du parloir." },
    "§ Vous ne le saviez pas ce matin-là. Vous le savez maintenant, ce qui est très exactement ce qui vous a pris douze ans.",
    { sobre:"Sa réponse fait deux lignes.",
      intense:"Sa réponse arrive en Ventôse et fait deux lignes.\n\n^« Vous vouliez que quelqu'un qui savait reste en vie pour le voir. C'est ce que j'ai fait pendant douze ans et c'est la seule chose utile que j'aie faite de ma vie entière. »",
      extreme:"Sa réponse arrive en Ventôse. Elle fait deux lignes, écrites de la même main qui n'a pas tremblé.\n\n^« Vous vouliez que quelqu'un qui savait reste en vie assez longtemps pour le voir. C'est ce que j'ai fait pendant douze ans, depuis un parloir de dix pieds sur douze, et c'est très exactement la seule chose utile que j'aie faite de ma vie entière.\n\nJe meurs cet hiver. Ne venez pas. Quatre lieues, c'est trop peu pour que ça veuille dire quelque chose, et vous le savez depuis le premier jour. »" },
    "Elle meurt en Germinal. Sainte-Ombre l'enterre au carré des sœurs, sous le nom qu'elle a porté trente et un ans.",
  ],
...
in_ys_silence:{
  ...
  titre:"Rien",
  texte:[
    "Vous n'écrivez pas. C'est ce que vous avez fait il y a douze ans en refermant une porte, et c'est cohérent, et la cohérence n'a jamais été une vertu.",
    { sobre:"Elle n'écrit pas non plus.",
      intense:"Elle n'écrit pas non plus. Elle n'a jamais rien demandé et elle ne commencera pas à quatre-vingt-un ans.\n\nLa confirmation, elle, tient. Un acte de commissariat ne dépend pas de ce qu'on en fait ensuite.",
      extreme:"Elle n'écrit pas non plus.\n\nElle n'a rien demandé en douze ans, elle n'a rien demandé dans le parloir, elle n'a rien demandé dans les quatre lignes de l'acte — et elle ne commencera pas à quatre-vingt-un ans.\n\nLa confirmation tient. Un acte de commissariat aux titres ne dépend absolument pas de ce qu'on en fait ensuite : il est enregistré, il est daté, il est scellé, et il rendra le relèvement de Karlsberg inattaquable pendant trois cents ans, que quiconque lui réponde ou non.\n\nC'est probablement le seul geste entièrement gratuit de toute cette histoire." },
    "§ Elle meurt en Germinal. Sainte-Ombre l'enterre au carré des sœurs, sous le nom qu'elle a porté trente et un ans, et personne de Karlsberg n'y est.",
  ],
