...
tr_pont:{
  ...
  texte:[
    ...
    "« Je suis le douzième. »",
    "« Les onze ont menti. Pas tous en mentant — trois ont dit des choses vraies qu'ils s'étaient déjà dites cent fois, ce qui est la même chose et qui coûte pareil. »",
    "§ « Une chose vraie que tu n'as dite à personne. Et que tu ne t'es pas dite non plus. »",
    "« Sinon ? »",
    "« Sinon tu ne passes pas. Je ne te tuerai pas : je n'ai tué personne sur ce pont en deux cent onze ans, et je ne vais pas commencer pour du grain. Tu ne passeras pas, c'est tout, et ton grain pourrira, et ce sera à toi de vivre avec. »",
    () => a('tr_sait_perte')
...
tr_blessure:{
  ...
  texte:[
    ...
    "« Alors ça ne rentre pas. » Il n'y a aucun reproche dedans. « Ce n'est pas ta faute. Une chose qu'on se raconte, on l'a déjà rangée : elle a une forme, elle a des mots, elle a un début et une fin. Ce n'est plus de la mémoire, c'est un objet. »",
...
tr_adelie_conte:{
  ...
  texte:[
    ...
    "« Ça ne paie pas. Ce n'est pas la même chose. » Il tourne enfin la tête vers vous. « Elle a trente et un ans, elle tient les granges, elle a dit non à tout depuis quatre ans, et personne dans cette province ne le saura jamais. Maintenant quelqu'un le sait. Ça vaut d'être gardé, mais ça ne vaut pas un passage : ce n'est pas toi qui l'as payé. »",
...
tr_mensonge_ko:{
  ...
  texte:[
    ...
    "« Tu peux essayer encore. Mais pas ça : tu ne sais faire que ça bien, et ce que tu sais faire bien ne me sert à rien. »",
  ],
...
tr_mere:{
  ...
  texte:[
    ...
    "« Elle a payé le sou par essieu. C'était encore le tarif. Et elle a parlé, parce que les gens parlent sur ce pont — pas parce que je le demande : parce qu'il fait quarante pieds au-dessus de l'eau, qu'il fait nuit, et qu'il y a quelqu'un d'assis. »",
    "« Qu'est-ce qu'elle a dit ? »",
    "« Tu es sûr de vouloir ça ? »",
    "« Oui. »",
    "« Réfléchis encore. Ce que je garde, je le garde entier : je ne l'arrange pas, je ne l'adoucis pas, et je ne peux pas te rendre la moitié. »",
    "« Oui. »",
    ...
    "§ Il rouvre les yeux.",
    "« Voilà. Je te l'ai rendu entier. Elle n'a pas dit le nom : elle ne l'a dit à personne, et je ne l'ai pas. »",
...
tr_c_onde_dom:{
  texte:[
    ...
    "« Je n'ai pas dit— »",
    "« Non. » Il caresse le joint du pouce. « Mais j'ai deux cent onze ans, et j'ai vu ça deux fois, et la deuxième c'était une femme sur ce pont il y a vingt ans qui avait deux enfants et une charrette de louage. »",
