...
as_greffe_dom:{
  ...
  effets:{ flags:['as_greffe','as_sait_rature','sans_ordonnance'],
...
as_greffe_ok:{
  ...
  effets:{ flags:['as_greffe','as_sait_rature'],
...
as_greffe_ko:{
  ...
  effets:{ flags:['as_greffe'], cout:{ moral:3 } },
  suite:'as_audience', libelleSuite:"Revenir dans la salle" },
...
as_sorgue_dom:{
  ...
  effets:{ flags:['as_sorgue','as_sait_sorgue','as_sait_hanche','as_sait_regles'],
...
as_sorgue_ok:{
  ...
  effets:{ flags:['as_sorgue','as_sait_sorgue'],
...
as_parler_loys:{
  ...
  effets:{ flags:['as_parle','as_loys_parle'], cout:{ moral:6 },
...
as_parler_clerc:{
  ...
  texte:[
    ...
    "« Je n'ai commis aucune faute. J'ai transcrit une pièce du répertoire à la demande d'une partie ayant intérêt, contre paiement déclaré, avec mention de la cote. C'est la procédure. C'est exactement la procédure. »",
    "« Je sais. »",
  ...
  effets:{ flags:['as_parle','as_sait_rature','sans_ordonnance'],
...
as_parler_tailleur:{
  ...
  effets:{ flags:['as_parle','as_tailleur_ignore'], cout:{ moral:5 },
...
as_parler_amaury:{
  ...
  effets:{ flags:['as_parle','as_sait_achat_archives'],
...
as_parler_gassien:{
  ...
  texte:[
    ...
    "« Donner quelqu'un de plus intéressant. Ce n'est pas la même chose et c'est toute mon expérience professionnelle. »",
  ...
  effets:{ flags:['as_parle','as_gassien_marche'],
...
as_parler_sergent:{
  ...
  effets:{ flags:['as_parle','as_sait_304'], cout:{ moral:4 },
...
as_vasque:{
  ...
  effets:{ flags:['as_vasque','as_sait_vasque','sans_ordonnance'], suspicion:14,
...
as_nom_cout:{
  ...
  texte:[
    ...
    "« Le rire est une réponse de salle. Ce n'en est pas une de procédure. »",
